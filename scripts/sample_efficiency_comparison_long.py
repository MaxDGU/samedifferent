#!/usr/bin/env python3
"""
Sample Efficiency Comparison: FOMAML vs Second-Order MAML vs Vanilla SGD (LONG VERSION)
...
LONG VERSION uses parameters from previous successful experiments:
- 10 adaptation steps for training
- 15 adaptation steps for testing/validation
- 25 epochs for thorough evaluation
- In-distribution evaluation (same tasks for train/val)
...
def plot_comparison(results_list, save_dir):
    ...
    plt.title('Sample Efficiency Comparison: FOMAML vs Second-Order MAML vs Vanilla SGD (LONG VERSION)\n(Conv6 Architecture, 10 Train Steps / 15 Test Steps)', fontsize=16)
