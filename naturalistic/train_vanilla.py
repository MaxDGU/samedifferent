...
class NaturalisticDataset(Dataset):
    ...
    def __init__(self, root_dir, split='train'):
        ...
        # Define transforms
        # Note: Using ImageNet normalization for naturalistic images, unlike the synthetic baseline
        # experiments which use [-1, 1] normalization. This choice is justified by the real-world
        # nature of the images in this dataset, which have similar statistics to ImageNet.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, required=True, help='Path to objectsall_2 directory')
